...
export default function Navigation() {
  ...
  // Chat/message icon component for feedback
  const ChatIcon = () => (
    <svg
      className="h-5 w-5"
      ...
      <div className="max-w-7xl mx-auto px-responsive">
        <div className="flex justify-between h-16 sm:h-18">
          ...
          <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
            ...
            {/* Feedback Option */}
            <div data-testid="nav-feedback">
              <FeedbackTrigger 
                variant="menu" 
                className="min-h-touch px-4 py-2 text-responsive-sm font-medium rounded-lg transition-colors flex items-center text-gray-700 hover:text-blue-600 hover:bg-gray-50"
              >
                <ChatIcon />
        ...
        <div className="md:hidden border-t border-gray-200 bg-white" data-testid="nav-menu">
          <div className="px-responsive py-4 space-y-2">
            ...
            >
              <FeedbackTrigger 
                variant="menu" 
                className="nav-link-mobile text-gray-700 hover:text-blue-600 hover:bg-gray-50"
              >
                <ChatIcon />
                <span>Feedback</span>
              </FeedbackTrigger>
